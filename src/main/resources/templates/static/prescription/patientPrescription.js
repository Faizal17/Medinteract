let dName;
    ...
    $.when(
        ...
        const getEmail = mergedData.map((data) => {
            return {
                d: data.doctorName,
            }
        })
            ...
            success: function (response) {
                for (let i = 0; i < response.data.length; i++) {
                    ...
                    if (buttonId === response.data[i].id.toString()) {
                        ...
                        let header = `<h2 class="fs-6"><i class="bi bi-envelope"></i>&nbsp${email}</h2><br>
                        <h2 class="fs-6"><i class="bi bi-telephone"></i>&nbsp${number}</h2><br>
                        <h2 class="fs-6"><i class="bi bi-pin-map-fill"></i>&nbsp${address}</h2><br>
                        <h2 class="fs-6">Prescription</h2>
                        `;
                        ...
                        let footer = `<h3 class="fs-6"><i class="bi bi-calendar-date"></i>&nbsp${time}</h3>`;
